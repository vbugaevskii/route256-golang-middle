...
type CheckoutClient interface {
	AddToCart(ctx context.Context, in *RequestAddToCart, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteFromCart(ctx context.Context, in *RequestDeleteFromCart, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ListCart(ctx context.Context, in *RequestListCart, opts ...grpc.CallOption) (*ResponseListCart, error)
	Purchase(ctx context.Context, in *RequestPurchase, opts ...grpc.CallOption) (*ResponsePurchase, error)
}
...
func (c *checkoutClient) AddToCart(ctx context.Context, in *RequestAddToCart, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *checkoutClient) DeleteFromCart(ctx context.Context, in *RequestDeleteFromCart, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *checkoutClient) ListCart(ctx context.Context, in *RequestListCart, opts ...grpc.CallOption) (*ResponseListCart, error) {
	out := new(ResponseListCart)
...
func (c *checkoutClient) Purchase(ctx context.Context, in *RequestPurchase, opts ...grpc.CallOption) (*ResponsePurchase, error) {
	out := new(ResponsePurchase)
...
type CheckoutServer interface {
	AddToCart(context.Context, *RequestAddToCart) (*emptypb.Empty, error)
	DeleteFromCart(context.Context, *RequestDeleteFromCart) (*emptypb.Empty, error)
	ListCart(context.Context, *RequestListCart) (*ResponseListCart, error)
	Purchase(context.Context, *RequestPurchase) (*ResponsePurchase, error)
...
func (UnimplementedCheckoutServer) AddToCart(context.Context, *RequestAddToCart) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutServer) DeleteFromCart(context.Context, *RequestDeleteFromCart) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteFromCart not implemented")
}
func (UnimplementedCheckoutServer) ListCart(context.Context, *RequestListCart) (*ResponseListCart, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCart not implemented")
}
func (UnimplementedCheckoutServer) Purchase(context.Context, *RequestPurchase) (*ResponsePurchase, error) {
...
func _Checkout_AddToCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).AddToCart(ctx, req.(*RequestAddToCart))
	}
...
func _Checkout_DeleteFromCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).DeleteFromCart(ctx, req.(*RequestDeleteFromCart))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).ListCart(ctx, req.(*RequestListCart))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_Purchase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).Purchase(ctx, req.(*RequestPurchase))
	}
	return interceptor(ctx, in, info, handler)
}
