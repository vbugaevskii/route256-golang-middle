...
type LomsClient interface {
	...
	ListOrder(ctx context.Context, in *RequestListOrder, opts ...grpc.CallOption) (*ResponseListOrder, error)
	OrderPayed(ctx context.Context, in *RequestOrderPayed, opts ...grpc.CallOption) (*emptypb.Empty, error)
	CancelOrder(ctx context.Context, in *RequestCancelOrder, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Stocks(ctx context.Context, in *RequestStocks, opts ...grpc.CallOption) (*ResponseStocks, error)
}
...
func (c *lomsClient) CreateOrder(ctx context.Context, in *RequestCreateOrder, opts ...grpc.CallOption) (*ResponseCreateOrder, error) {
...
func (c *lomsClient) ListOrder(ctx context.Context, in *RequestListOrder, opts ...grpc.CallOption) (*ResponseListOrder, error) {
	out := new(ResponseListOrder)
...
func (c *lomsClient) OrderPayed(ctx context.Context, in *RequestOrderPayed, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *lomsClient) CancelOrder(ctx context.Context, in *RequestCancelOrder, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *lomsClient) Stocks(ctx context.Context, in *RequestStocks, opts ...grpc.CallOption) (*ResponseStocks, error) {
	out := new(ResponseStocks)
...
type LomsServer interface {
	...
	ListOrder(context.Context, *RequestListOrder) (*ResponseListOrder, error)
	OrderPayed(context.Context, *RequestOrderPayed) (*emptypb.Empty, error)
	CancelOrder(context.Context, *RequestCancelOrder) (*emptypb.Empty, error)
	Stocks(context.Context, *RequestStocks) (*ResponseStocks, error)
...
func (UnimplementedLomsServer) CreateOrder(context.Context, *RequestCreateOrder) (*ResponseCreateOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOrder not implemented")
}
func (UnimplementedLomsServer) ListOrder(context.Context, *RequestListOrder) (*ResponseListOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListOrder not implemented")
}
func (UnimplementedLomsServer) OrderPayed(context.Context, *RequestOrderPayed) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderPayed not implemented")
}
func (UnimplementedLomsServer) CancelOrder(context.Context, *RequestCancelOrder) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelOrder not implemented")
}
func (UnimplementedLomsServer) Stocks(context.Context, *RequestStocks) (*ResponseStocks, error) {
...
func _Loms_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).CreateOrder(ctx, req.(*RequestCreateOrder))
	}
...
func _Loms_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).ListOrder(ctx, req.(*RequestListOrder))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Loms_OrderPayed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).OrderPayed(ctx, req.(*RequestOrderPayed))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Loms_CancelOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).CancelOrder(ctx, req.(*RequestCancelOrder))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Loms_Stocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).Stocks(ctx, req.(*RequestStocks))
	}
	return interceptor(ctx, in, info, handler)
}
